...
# last_two_bits = number_bin[-2:]
# reversed_bits = last_two_bits[::-1]
...
def main():
    number = int(input("Enter an integer greater than 9: "))
    ...
    reversed_bits = last_two_bits[::-1]  # reverse the bits

    try:
        decimal_number = bin_to_dec(reversed_bits)
        print(f"The reversed last two bits in decimal form are: {decimal_number}")
